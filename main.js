...
function loguearUsuario(e) {
    ...
    if (recuperarUsuario == null) {
        ...
        //mensaje.innerText = "Te has logueado correctamente";
...
function compararResultados() {
        ...
        misResultados.forEach(function (j) {
            if (i.id == j.id) {
                ...
                function pronosticoExacto() {
                    ...
                    // const resultadoComparado = document.createElement("p");
                    // resultadoComparado.innerHTML = msg1;
                    // document.getElementById(`comparacion_${i.id}`).appendChild(resultadoComparado)
                }
                ...
                function partidoEmpate() {
                    ...
                    // const resultadoComparado = document.createElement("p");
                    // resultadoComparado.innerHTML = msg2;
                    // document.getElementById(`comparacion_${i.id}`).appendChild(resultadoComparado)
                }
                ...
                function partidoganaLocal() {
                    ...
                    // const resultadoComparado = document.createElement("p");
                    // resultadoComparado.innerHTML = msg3;
                    // document.getElementById(`comparacion_${i.id}`).appendChild(resultadoComparado)
                }
                ...
                function partidoganaVisitante() {
                    ...
                    document.getElementById(`comparacion_${i.id}`).innerHTML = puntaje;
                    // const resultadoComparado = document.createElement("p");
                    // resultadoComparado.innerHTML = msg4;
                    // document.getElementById(`comparacion_${i.id}`).appendChild(resultadoComparado)
                }
                ...
                function pronosticoFallido() {
                    ...
                    document.getElementById(`comparacion_${i.id}`).innerHTML = puntaje;
                    // const resultadoComparado = document.createElement("p");
                    // resultadoComparado.innerHTML = msg5;
                    // document.getElementById(`comparacion_${i.id}`).appendChild(resultadoComparado)
                }
            }
        })
    ...
    nuevoPuntajeEnTabla()
    motrarTotal()
    botonComparar.removeEventListener('click', compararResultados);
